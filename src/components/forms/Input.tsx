...
const inputConfig = {
  basic:
    "rounded-md border focus:outline-none focus:ring-4 focus:ring-opacity-50 appearance-none",
...
const inputModeConfig: { [key in InputMode]: string } = {
  default:
    "text-gray-900 bg-gray-50 border-gray-300 focus:border-primary focus:ring-primary-300",
  success:
    "bg-green-50 border-green-500 focus:border-green-500 focus:ring-green-300 text-green-900 placeholder-green-700",
  failed:
    "bg-red-50 border-red-500 focus:border-red-500 focus:ring-red-500 text-red-900 placeholder-red-700",
};
