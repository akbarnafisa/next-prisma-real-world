...
import { ArticleDocument, type ArticleQuery, type ArticleViewFragment } from '../../generated/graphql';
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  // need to clear manually -> no need, already set the type policy to be false for SSR
